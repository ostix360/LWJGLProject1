...
import fr.ostix.game.openGLUtils.uniform.Vector2fUniform;
...
public class FontShader extends ShaderProgram {
    ...
    private Vector3fUniform color = new Vector3fUniform("color");
    private Vector2fUniform translation = new Vector2fUniform("translation");
