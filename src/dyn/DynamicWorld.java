package fr.ostix.game.world.dyn;

import fr.ostix.game.core.collision.react.*;
import fr.ostix.game.core.collision.react.ContactManifold.ContactManifoldListElement;
import fr.ostix.game.core.collision.react.body.CollisionBody;
import fr.ostix.game.core.collision.react.body.RigidBody;
import fr.ostix.game.core.collision.react.constraint.ContactPoint;
import fr.ostix.game.core.collision.react.constraint.ContactPoint.ContactPointInfo;
import fr.ostix.game.core.collision.react.maths.*;
...
public class DynamicWorld extends CollisionWorld {
    ...
    private final float mSleepLinearVelocity;
    private final float mSleepAngularVelocity;
    private final float mTimeBeforeSleep;
    private final int mNbVelocitySolverIterations;
    private final int mNbPositionSolverIterations;
    ...
    private final boolean mIsSleepingEnabled;
    private final boolean mIsGravityEnabled;
     ...
     */
    public DynamicWorld(Vector3 gravity, float timeStep) {
    ...
    protected void tick() {
        ...
        mCollisionDetection.computeCollisionDetection();            //Collision detection
        /*
            apply a correction to the collided body
                */
        ...
        updateRigidBodiesAABB();        //TO AABB of body
    }
    ...
    private void computeIslands() {
        ...
        for (RigidBody body : mRigidBodies) {
            ...
            mIslands[mNbIslands] = new Island(nbBodies, mContactManifolds.size());
            while (stackIndex > 0) {
                stackIndex--;
        ...
        for (int i = 0; i < mNbIslands; i++) {
            ...
            for (int b = 0; b < mIslands[i].getNbBodies(); b++) {
                ...
                if (bodies[b].isMotionEnabled()) {
                    ...
                    System.out.println("bodies[b].getLinearVelocity() " + bodies[b].getLinearVelocity()+"b "+ b);
    ...
    private void solveContactsAndConstraints() {
        ...
        for (int islandIndex = 0; islandIndex < mNbIslands; islandIndex++) {
            ...
            System.out.println("velocity "+mConstrainedLinearVelocities[0]);
        ...
        for (int i = 0; i < mNbIslands; i++) {
            ...
            for (int b = 0; b < mIslands[i].getNbBodies(); b++) {
                if (bodies[b].isMotionEnabled()) {
                    ...
                    System.out.println("newLinVelocity " + newLinVelocity );
    ...
    public void addContactManifoldToBody(ContactManifold contactManifold, CollisionBody body1, CollisionBody body2) {
        ...
        final ContactManifold.ContactManifoldListElement listElement1 = new ContactManifoldListElement(contactManifold, body1.getContactManifoldsLists());
